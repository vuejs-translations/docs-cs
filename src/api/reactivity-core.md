...
Přijímá [getter funkci](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/get#description) a vrací reaktivní objekt [ref](#ref) pouze pro čtení s vnitřní hodnotou vrácenou z getteru. Může také přijmout objekt s funkcemi `get` a `set` pro vytvoření zapisovatelného objektu ref.
