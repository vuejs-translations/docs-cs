...
- **Podrobnosti**
  ...
  Kromě běžných vlastností komponenty podporuje `defineCustomElement()` také speciální vlastnost `styles`, která by měla být polem vložených CSS řetězců, které poskytují CSS, které by mělo být vloženo do stínového root elementu.
