...
V příkladu níže definujeme komponentu `Card` s dvěma podmíněnými sloty: `header` a&nbsp;`footer`.
Pokud je header / footer předán (přítomen v objektu), chceme jej obalit dodatečným stylováním:
